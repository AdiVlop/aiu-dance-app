...
Dimensiuni recomandate pentru Gmail: 96x96 px sau 192x192 px
"""

from PIL import Image, ImageDraw, ImageFont
import os

def create_gmail_favicon():
    # Dimensiuni pentru favicon Gmail
    size = 192  # 192x192 px pentru Gmail
    ...
    if os.path.exists(logo_path):
        try:
            ...
            logo_size = int(size * 0.6)  # 60% din dimensiunea totală
    ...
    output_path = os.path.join(downloads_path, "aiu_dance_gmail_favicon.png")
    img.save(output_path, 'PNG')
    
    print(f"✅ Favicon Gmail AIU Dance creat cu succes!")
